...
function showDiv(arr1)
{
   ...
   document.getElementById("id_win").style.display="none";//הודעת סיום משחק אינה מוצגת בהתחלה
}



let bool=false;
let id1;//משתנה1 שמכיל את האיידי של תמונה
let id2;//משתנה 2 שמכיל את האיידי של תמונה
let count=0;// 
let counter=0;//סופר כמה זוגות קלפים הם במצב דיספליי מוצג-כמה זוגות ניחשנו
let isOn;
